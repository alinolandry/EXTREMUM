...
<html>
    ...
    <body>
        ...
        <form class="well" method="POST" action="acceuil.php">
            <legend> Veuillez remplir les champs pour le calcul la Valeur nominale </legend>
            <div class="form-group">
                ...
                <div class="form-group col-lg-2 col-lg-offset-1">
                    <input type="submit" name="submit41" value="Solution" class="form-control btn btn-success"><br><br><br>
