...
<html>
    ...
    <body>
        <div class="">
            ...
            <legend> Veuillez remplir les champs pour le calcul de l'escompte</legend>
            <div class="form-group">
                ...
                <div class="form-group col-lg-2 col-lg-offset-1">
                    <input type="submit" name="submit20" value="Solution" class="form-control btn btn-success"> 
                        <br><br><br>
                ...
                <?php
                    if(isset($_POST['submit20']))
                    {
                        echo '<div class="col-lg-4 btn btn-success">
                            <h4>La valeur de l\' escompte est:</h4>
                            <h3>'.$solution.'</h3> FCFA
                           </div>';
                    }
